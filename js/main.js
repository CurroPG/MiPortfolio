...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        es: {
            ...
            "project-springboot-title": "Spring Boot",
            "project-springboot-desc": "Desarrollo backend con Java y el framework Spring Boot e integración con vistas HTML.",
        ...
        en: {
            ...
            "project-springboot-title": "Spring Boot",
            "project-springboot-desc": "Backend development with Java and the Spring Boot framework, including HTML views integration.",
            "repo-btn": "Repository",
